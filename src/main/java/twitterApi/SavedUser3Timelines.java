 ...
 * @author Babathurpe
 */
public class SavedUser3Timelines extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String savedUser = getRow("Select timeline3 from timelines where user_id=?", userId);
    ...
    private String getRow(String query, String... params) {
        ...
        try {
            ...
            while (rs.next()) {
                sb.append(rs.getString("timeline3"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(SavedUser3Timelines.class.getName()).log(Level.SEVERE, null, ex);
        }
